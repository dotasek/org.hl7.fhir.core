...
//  public static final String DEF_TX = "http://local.fhir.org:960";
  ...
  public void testCurrentXml() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine.ValidationEngineBuilder()
      .withTxServer(DEF_TX, null, FhirPublication.R4)
      .withVersion("4.0.1")
  ...
  public void test140() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine.ValidationEngineBuilder()
      .withTxServer(DEF_TX, null, FhirPublication.DSTU2016May)
      .withVersion("1.4.0").withUserAgent("fhir/test-cases")
  ...
  public void test102() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine.ValidationEngineBuilder()
      .withTxServer(DEF_TX, null, FhirPublication.DSTU2)
      .withVersion("1.0.2").withUserAgent("fhir/test-cases")
  ...
  public void test301() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine.ValidationEngineBuilder()
      .withTxServer(DEF_TX, null, FhirPublication.STU3)
      .withVersion("3.0.2").withUserAgent("fhir/test-cases")
